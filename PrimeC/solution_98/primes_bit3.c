...
/*
printf("get_first_index(0)=%u\n",get_first_index(0));
printf("get_first_index(1)=%u\n",get_first_index(1));

printf("get_last_index(0)=%u\n",get_last_index(0));
printf("get_last_index(1)=%u\n",get_last_index(1));

printf("index_to_natural(1)=%u\n",index_to_natural(1));
printf("index_to_natural(2)=%u\n",index_to_natural(2));

printf("natural_to_index(3)=%u\n",natural_to_index(3));
printf("natural_to_index(4)=%u\n",natural_to_index(4));
printf("natural_to_index(5)=%u\n",natural_to_index(5));
printf("natural_to_index(1000)=%u\n",natural_to_index(1000));
*/
