...
for x in test_loop get_cache_info primes_words8 primes_words7 primes_words6 primes_words5 primes_words3 primes_words primes_words2 primes_bit2 primes_bit primes_char primes_int ; do
    $CC -o $x $x.c -lm
done
