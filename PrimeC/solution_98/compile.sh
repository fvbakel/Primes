...
#for x in primes_words primes_words12 primes_words11 primes_words10 primes_words09 primes_bit primes_bit2 primes_bit3 primes_bit4 primes_bit5 primes_bit6 primes_bit7; do
#    $CC -o ${x} ${x}.c -lm
#done
x=primes_bit7
for store_mode in 0 1 2 3 4; do
    for crossout_mode in 0 1 2 3 4 5 6; do
